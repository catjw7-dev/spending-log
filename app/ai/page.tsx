    ...
    <div className="flex flex-col min-h-screen pb-24 bg-toss-bg dark:bg-[#0d1117]">
      <div className="bg-white dark:bg-toss-card-dark px-5 pt-14 pb-5 sticky top-0 z-10 shadow-sm">
        <h1 className="text-[17px] font-semibold text-toss-text dark:text-white flex items-center gap-2">
          <Sparkles size={18} className="text-toss-blue" />AI 소비 분석
        </h1>
      ...
      <div className="px-4 pt-4">
        {!result && !loading && (
          <div className="flex flex-col items-center justify-center py-20 text-center">
            ...
            <button onClick={analyze} className="flex items-center gap-2 px-6 py-3.5 bg-toss-blue text-white rounded-2xl text-[15px] font-semibold active:scale-95 transition-transform" style={{boxShadow:"0 4px 20px rgba(49,130,246,0.35)"}}>
        ...
        {result && (
          <div className="space-y-3">
            ...
            <button onClick={analyze} className="w-full flex items-center justify-center gap-2 py-3.5 bg-white dark:bg-toss-card-dark rounded-2xl border border-toss-border dark:border-toss-border-dark text-[14px] font-medium text-toss-text-3 shadow-card hover:bg-toss-bg dark:hover:bg-toss-bg-dark transition-colors">
